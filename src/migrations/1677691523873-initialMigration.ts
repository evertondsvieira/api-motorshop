...
export class initialMigration1677691523873 implements MigrationInterface {
    name = 'initialMigration1677691523873'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "annoucements" ("annoucementId" SERIAL NOT NULL, "title" character varying(50) NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "adType" "public"."annoucements_adtype_enum" NOT NULL DEFAULT 'sale', "year" integer NOT NULL, "mileage" integer NOT NULL, "price" numeric(23,2) NOT NULL, "description" character varying(350) NOT NULL, "vehicleType" "public"."annoucements_vehicletype_enum" NOT NULL, "coverImage" character varying NOT NULL, "user_id" integer, CONSTRAINT "PK_2b75bf7102ce639a5a9cd9ca817" PRIMARY KEY ("annoucementId"))`);
        await queryRunner.query(`CREATE TABLE "comments" ("id" SERIAL NOT NULL, "text" character varying(450) NOT NULL, "createAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "annoucementsAnnoucementId" integer, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "annoucements" ADD CONSTRAINT "FK_332a4ca850e1d31ce041d8ea722" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
